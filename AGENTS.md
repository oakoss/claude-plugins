...
- Direct releases remain valid for hand-cut cases: bump `plugin.json` + `marketplace.json` + changelog heading together (`pnpm run version` after writing a bump file does this locally).
