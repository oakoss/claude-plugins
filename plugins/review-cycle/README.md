...
The gate shows the whole command in its dialog, and does not ask about one longer than 500 characters as shown. Ask for the commit in your message, or have the agent use a shorter commit message.
